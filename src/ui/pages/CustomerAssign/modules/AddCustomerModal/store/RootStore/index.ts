...
import { IAddCustomerModalProps } from "../../interface";
...
export class RootStore implements IRootStore {
  ...
  constructor(refs: IRefs) {
    this.refs = refs;
    this.propsStore = new PropsStore<IAddCustomerModalProps>();
...
export const { Provider, useStore } = createContainer(() => {
  ...
  return useLocalObservable(() => new RootStore({ addCustomerForm }));
});
