...
import { IPastListOfDpts, IPastListOfDptsProps } from "../../interface";
...
export interface ILogic {
  ...
  /** @function 列表项操作 */
  onAction(action: TAction, record: IPastListOfDpts): void;
  /** @function 刷新 */
  refresh(): void;
}
...
export interface IRootStore {
  ...
  computed: Computed;
  loadingStore: TLoadingStore;
  propsStore: PropsStore<IPastListOfDptsProps>;
  refs: IRefs;
}
