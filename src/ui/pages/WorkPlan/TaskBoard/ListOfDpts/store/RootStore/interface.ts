...
import { IListOfDpts, IListOfDptsProps } from "../../interface";
...
export interface ILogic {
  ...
  rootStore: RootStore;
  /** @param 列表数据源 */
  dataSource: IListOfDpts[];
  /** @param 按日期查看列表数据源 */
  dataSourceByDate: IListOfDpts[];
  /** @param 列表分页信息 */
  ...
  /** @function 列表项操作 */
  onAction(action: TAction, record: IListOfDpts): void;
  /** @function 刷新 */
  refresh(): void;
}
...
export interface IRootStore {
  ...
  computed: Computed;
  loadingStore: TLoadingStore;
  propsStore: PropsStore<IListOfDptsProps>;
  refs: IRefs;
}
