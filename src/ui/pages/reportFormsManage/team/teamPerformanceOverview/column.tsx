...
export const useColumnsOverview = (params: { logic: any }) => {
  const { logic } = params;
          ...
          <div className="flex gap-1">
            {TeamAuth.teamPerformance_teamDetail && (
              <Button
                ...
                size="small"
                onClick={() => {
                  logic.openTeamPerformanceDraw(record);
                }}
              >
                团队详情
              </Button>
            ...
            {TeamAuth.teamPerformance_channelDetail && (
              <Button
                type="link"
                size="small"
                onClick={() => {
                  logic.openChannelDetailDraw(record);
                }}
              >
                渠道详情
              </Button>
