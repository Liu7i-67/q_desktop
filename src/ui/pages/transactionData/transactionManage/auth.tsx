...
class _DealManagementAuth {
  private static _instance: _DealManagementAuth;

  constructor(private userHelper: UserHelper) {}

  static get instance() {
    if (!_DealManagementAuth._instance) {
      _DealManagementAuth._instance = new _DealManagementAuth(
        UserHelper.getInstance()
      );
    }
    return _DealManagementAuth._instance;
  }
...
// 导出单例
export const DealManagementAuth = _DealManagementAuth.instance;
